...
## Dataset
The source of dataset used for this project is the https://drive.google.com/file/d/1ZSlLH41B8UK_vaV_fxagucHNxVp8ALJK/view?usp=sharing from kaggle. It contains various attributes such as age, sex, cholesterol levels, and exercise-induced angina, which are used to predict the presence of heart disease.
...
2. **Optimized Neural Network Model**: This model applies optimization techniques to enhance its performance. These techniques include regularization methods L1 and L2 regularization.

## Implementation Details
- **Libraries Used**: The project utilizes popular Python libraries such as NumPy, Pandas, Scikit-learn,model building, and evaluation.
...
3. Open the notebook (`notebook.ipynb`) using Google Colab.
